...
public class JJJVMClassTest extends TestHelper {
  ...
  public void test_LDCW_ARETURN_string() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new LDC_W(CP_STRING), new ARETURN());
    assertEquals(CONST_STR, executeTestMethod(test, Object.class, null, 0));

    final JJJVMClass test2 = prepareTestClass(new DefaultProvider(), Type.OBJECT, new LDC_W(CP_STRING_H), new ARETURN());
  ...
  public void test_LDC2W_LRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LDC2_W(CP_LONG), new LRETURN());
    assertEquals(CONST_LNG, executeTestMethod(test, Long.class, null, 0).longValue());

    final JJJVMClass test2 = prepareTestClass(new DefaultProvider(), Type.LONG, new LDC2_W(CP_LONG_H), new LRETURN());
  ...
  public void test_ALOAD_ASTORE_ALOAD_ARETURN_notNull() throws Throwable {
    ...
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new ASTORE(280), new ALOAD(280), new ARETURN());
  ...
  public void test_ILOAD_ISTORE_ILOAD_IRETURN_Wide() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ISTORE(280), new ILOAD(280), new IRETURN());
  ...
  public void test_ILOAD_ISTORE_ILOAD_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ISTORE(2), new ILOAD(2), new IRETURN());
    assertEquals(1234, executeTestMethod(test, Integer.class, null, 1234).intValue());
  }

  @Test
  public void test_LLOAD_LSTORE_LLOAD_LRETURN_Wide() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new LSTORE(280), new LLOAD(280), new LRETURN());
  ...
  public void test_LLOAD_LSTORE_LLOAD_LRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new LSTORE(2), new LLOAD(2), new LRETURN());
    assertEquals(123456789012345L, executeTestMethod(test, Long.class, null, 123456789012345L).longValue());
  }

  @Test
  public void test_FLOAD_FSTORE_FLOAD_FRETURN_Wide() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new FSTORE(280), new FLOAD(280), new FRETURN());
  ...
  public void test_FLOAD_FSTORE_FLOAD_FRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new FSTORE(2), new FLOAD(2), new FRETURN());
    assertEquals(123456.89f, executeTestMethod(test, Float.class, null, 123456.89f).floatValue(), 0.0f);
  }

  @Test
  public void test_DLOAD_DSTORE_DLOAD_DRETURN_Wide() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new DSTORE(280), new DLOAD(280), new DRETURN());
  ...
  public void test_DLOAD_DSTORE_DLOAD_DRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new DSTORE(2), new DLOAD(2), new DRETURN());
    assertEquals(1234567723442.89d, executeTestMethod(test, Double.class, null, 1234567723442.89d).doubleValue(), 0.0d);
  }

  @Test
  public void test_NEWARRAY_BALOAD_BASTORE_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public byte test(byte a){ byte [] array = new byte[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_ARRAYLENGTH_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new NEWARRAY(Type.INT),new ARRAYLENGTH(), new IRETURN());
  ...
  public void test_NEWARRAY_CALOAD_CASTORE_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public char test(char a){ char [] array = new char[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_SALOAD_SASTORE_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public short test(short a){ short [] array = new short[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_BALOAD_BASTORE_IRETURN_Boolean() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public boolean test(boolean a){ boolean [] array = new boolean[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_IALOAD_IASTORE_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ int [] array = new int[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_LALOAD_LASTORE_LRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a){ long [] array = new long[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_DALOAD_DASTORE_DRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public double test(double a){ double [] array = new double[100]; array[34] = a; return array[34];}");
  ...
  public void test_NEWARRAY_FALOAD_FASTORE_FRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public float test(float a){ float [] array = new float[100]; array[34] = a; return array[34];}");
  ...
  public void testMULTIANEWARRAY() throws Throwable {
    ...
    final DefaultProvider provider = new DefaultProvider(){
      @Override
  ...
  public void test_SWAP_POP_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new SWAP(), new POP(), new IRETURN());
  ...
  public void test_SWAP() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new SWAP(), new RETURN());
  ...
  public void test_DUP() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new DUP(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP_POP2_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new DUP(), new POP2(), new IRETURN());
    assertEquals(1, executeTestMethod(test, Integer.class, null, 0).intValue());
  }
  ...
  public void test_POP2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new POP2(), new ICONST(4), new ICONST(5), new IRETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP_X1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new DUP_X1(), new IRETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUPX1_IRETURN() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new DUP_X1(), new POP2(), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 0).intValue());
  }
  ...
  public void test_DUP_X2_ver1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new DUP_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP_X2_ver2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(1), new ICONST(2), new DUP_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_ver1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new DUP2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_ver2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(3), new LCONST(1), new DUP2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X1_ver1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new ICONST(4), new DUP2_X1(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X1_ver2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(3), new LCONST(1), new DUP2_X1(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X2_ver1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(1), new ICONST(2), new ICONST(3), new ICONST(4), new DUP2_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X2_ver2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(3), new ICONST(4), new LCONST(1), new DUP2_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X2_ver3() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(1), new ICONST(2), new ICONST(3), new DUP2_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_DUP2_X2_ver4() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(0), new LCONST(1), new DUP2_X2(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_IADD() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a) { return a+27863;}");
  ...
  public void test_LADD() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a) { return a+27863L;}");
  ...
  public void test_FADD() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public float test(float a) { return a+27863.34f;}");
  ...
  public void test_DADD() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public double test(double a) { return a+27863.34d;}");
  ...
  public void test_IDIV() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a) { return a/27;}");
  ...
  public void test_LDIV() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a) { return a/27L;}");
    assertEquals(Long.valueOf(-65423L / 27L), executeTestMethod(test, Long.class, null, -65423L));
  }

  @Test
  public void test_FDIV() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public float test(float a) { return a/27.34f;}");
  ...
  public void test_DDIV() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public double test(double a) { return a/27.34d;}");
  ...
  public void test_INEG() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new INEG(), new IRETURN());
    assertEquals(65, executeTestMethod(test, Integer.class, null, -65).intValue());
  }

  @Test
  public void test_LNEG() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new LNEG(), new LRETURN());
    assertEquals(65L, executeTestMethod(test, Long.class, null, -65L).longValue());
  }

  @Test
  public void test_FNEG() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new FNEG(), new FRETURN());
    assertEquals(65.332f, executeTestMethod(test, Float.class, null, -65.332f), 0.0f);
  }

  @Test
  public void test_DNEG() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new DNEG(), new DRETURN());
    assertEquals(65423.332d, executeTestMethod(test, Double.class, null, -65423.332d), 0.0d);
  }

  @Test
  public void test_ISHL() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ return a << 4;}");
    assertEquals(65 << 4, executeTestMethod(test, Integer.class, null, 65).intValue());
  }

  @Test
  public void test_LSHL() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a){ return a << 4;}");
    assertEquals(65L << 4, executeTestMethod(test, Long.class, null, 65L).longValue());
  }

  @Test
  public void test_ISHR() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ return a >> 2;}");
    assertEquals(65 >> 2, executeTestMethod(test, Integer.class, null, 65).intValue());
  }

  @Test
  public void test_LSHR() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a){ return a >> 2;}");
  ...
  public void test_IAND() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ return a & 342;}");
    assertEquals(265463 & 342, executeTestMethod(test, Integer.class, null, 265463).intValue());
  }

  @Test
  public void test_LAND() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public long test(long a){ return a & 342L;}");
  ...
  public void test_IINC() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new IINC(1, 13), new ILOAD(1), new IRETURN());
  ...
  public void test_IINC_Wide() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ISTORE(280), new IINC(280, 13), new ILOAD(280), new IRETURN());
    assertEquals(265463 + 13, executeTestMethod(test, Integer.class, null, 265463).longValue());
  }
  ...
  public void test_I2L() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(3), new I2L(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_I2D() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ICONST(3), new I2D(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_I2B() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new I2B(), new RETURN());
  ...
  public void test_I2C() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new I2C(), new RETURN());
    executeTestMethod(test, Integer.class, stack, -123334);
  ...
  public void test_I2F() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new I2F(), new RETURN());
  ...
  public void test_I2S() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new I2S(), new RETURN());
    executeTestMethod(test, Integer.class, stack, -123334);
  ...
  public void test_L2I() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new L2I(), new RETURN());
  ...
  public void test_L2F() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new L2F(), new RETURN());
    executeTestMethod(test, Long.class, stack, 1234L);
  ...
  public void test_L2D() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.LONG, new LLOAD(1), new L2D(), new RETURN());
    executeTestMethod(test, Long.class, stack, 1234L);
  ...
  public void test_D2I() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new D2I(), new RETURN());
  ...
  public void test_D2L() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new D2L(), new RETURN());
    executeTestMethod(test, Double.class, stack, -1234.234d);
  ...
  public void test_D2F() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new LLOAD(1), new D2F(), new RETURN());
    executeTestMethod(test, Double.class, stack, -1234.234d);
  ...
  public void test_F2I() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new F2I(), new RETURN());
  ...
  public void test_F2L() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new F2L(), new RETURN());
    executeTestMethod(test, Float.class, stack, 1234.123f);
    assertStack(new Object[]{null, 1234L, null}, stack);
  }
  ...
  public void test_F2D() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new F2D(), new RETURN());
    executeTestMethod(test, Float.class, stack, 1234.123f);
  ...
  public void test_LCMP_eq() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(1), new LCONST(1), new LCMP(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_LCMP_less() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(0), new LCONST(1), new LCMP(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
  ...
  public void test_LCMP_greater() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new LCONST(1), new LCONST(0), new LCMP(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPL_eq() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new FCONST(1.0f), new FCONST(1.0f), new FCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{0, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPL_less() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new FCONST(1.0f), new FCONST(0.0f), new FCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPL_greater() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new FCONST(0.0f), new FCONST(1.0f), new FCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{-1, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPL_nan1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new FCONST(1.0f), new FCMPL(), new RETURN());
  ...
  public void test_FCMPL_nan2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FCONST(1.0f), new FLOAD(1), new FCMPL(), new RETURN());
    executeTestMethod(test, Float.class, stack, Float.NaN);
    assertStack(new Object[]{-1, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPG_nan1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FLOAD(1), new FCONST(1.0f), new FCMPG(), new RETURN());
    executeTestMethod(test, Float.class, stack, Float.NaN);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_FCMPG_nan2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.FLOAT, new FCONST(1.0f), new FLOAD(1), new FCMPG(), new RETURN());
    executeTestMethod(test, Float.class, stack, Float.NaN);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPL_eq() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new DCONST(1.0d), new DCONST(1.0d), new DCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{0, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPL_less() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new DCONST(1.0d), new DCONST(0.0d), new DCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPL_greater() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new DCONST(0.0d), new DCONST(1.0d), new DCMPL(), new RETURN());
    executeTestMethod(test, Integer.class, stack, 0);
    assertStack(new Object[]{-1, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPL_nan1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new DCONST(1.0d), new DCMPL(), new RETURN());
  ...
  public void test_DCMPL_nan2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DCONST(1.0d), new DLOAD(1), new DCMPL(), new RETURN());
    executeTestMethod(test, Double.class, stack, Double.NaN);
    assertStack(new Object[]{-1, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPG_nan1() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DLOAD(1), new DCONST(1.0d), new DCMPG(), new RETURN());
    executeTestMethod(test, Double.class, stack, Double.NaN);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_DCMPG_nan2() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.DOUBLE, new DCONST(1.0d), new DLOAD(1), new DCMPG(), new RETURN());
    executeTestMethod(test, Double.class, stack, Double.NaN);
    assertStack(new Object[]{1, null, null, null, null, null}, stack);
  }
  ...
  public void test_IFEQ() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFEQ.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 0).intValue());
  ...
  public void test_IFNE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFNE.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
  ...
  public void test_IFLT() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFLT.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
  ...
  public void test_IFLE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFLE.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, -5).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 0).intValue());
  }
  ...
  public void test_IFGT() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFGT.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, -5).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 0).intValue());
  }
  ...
  public void test_IFGE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new Branch(IFGE.class, 4), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, -5).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 0).intValue());
  }
  ...
  public void test_IFICMPEQ() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPEQ.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
  ...
  public void test_IFICMPNE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPNE.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
  ...
  public void test_IFICMPLT() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPLT.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 3).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 8).intValue());
  }
  ...
  public void test_IFICMPLE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPLE.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 3).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 8).intValue());
  }
  ...
  public void test_IFICMPGT() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPGT.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 3).intValue());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 8).intValue());
  }
  ...
  public void test_IFICMPGE() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.INT, new ILOAD(1), new ICONST(5), new Branch(IF_ICMPGE.class, 5), new ICONST(3), new IRETURN(), new ICONST(2), new IRETURN());
    assertEquals(3, executeTestMethod(test, Integer.class, null, 3).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 5).intValue());
    assertEquals(2, executeTestMethod(test, Integer.class, null, 8).intValue());
  }
  ...
  public void test_IFACMPEQ() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new ACONST_NULL(), new Branch(IF_ACMPEQ.class, 5), new ICONST(3), new RETURN(), new ICONST(2), new RETURN());
  ...
  public void test_IFACMPNE() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new ACONST_NULL(), new Branch(IF_ACMPNE.class, 5), new ICONST(3), new RETURN(), new ICONST(2), new RETURN());
    executeTestMethod(test, Object.class, stack, new Object());
    assertStack(new Object[]{2, null, null, null}, stack);
    executeTestMethod(test, Object.class, stack, (Object) null);
    assertStack(new Object[]{3, null, null, null}, stack);
  ...
  public void test_GOTO() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new Branch(GOTO.class, 3), new ICONST(3), new RETURN(), new ICONST(2), new RETURN());
    executeTestMethod(test, Object.class, stack, new Object());
    assertStack(new Object[]{2, null, null, null}, stack);
  }
  ...
  public void test_GOTO_W() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new Branch(GOTO_W.class, 3), new ICONST(3), new RETURN(), new ICONST(2), new RETURN());
    executeTestMethod(test, Object.class, stack, new Object());
    assertStack(new Object[]{2, null, null, null}, stack);
  }
  ...
  public void test_JSR_RET() throws Throwable {
    final Object[] stack = new Object[100];
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new Branch(JSR.class, 2), new RETURN(), new ASTORE(85), new ICONST(2), new RET(85));
    executeTestMethod(test, Object.class, stack, new Object());
    assertStack(new Object[]{2, null, null, null}, stack);
  }
  ...
  public void test_WIDE_JSR_RET() throws Throwable {
    ...
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, instr.toArray());
    executeTestMethod(test, Object.class, stack, new Object());
    assertStack(new Object[]{2, null, null, null}, stack);
  }
  ...
  public void test_LOOKUPSWITCH() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){"
            + "switch(a){"
            + "case 1: return 5;"
            + "case 2: return 6;"
            + "case 3: return 7;"
  ...
  public void test_GETSTATIC_PUTSTATIC_sameClass() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ sfield=a; return sfield;}");
  ...
  public void test_GETSTATIC_PUTSTATIC_otherClass() throws Throwable {
    ...
    final JJJVMProvider processor = new DefaultProvider(){
  ...
  public void test_GETFIRLD_PUTFIELD_thisClass() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), "public int test(int a){ field=a; return field;}");
    assertEquals(9942343, executeTestMethod(test, Integer.class, null, 9942343).intValue());
  }
  ...
  public void testIFNULL() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new Branch(IFNULL.class, 4), new ICONST(1), new RETURN(), new ICONST(2), new RETURN());
    final Object [] stack = new Object[100];
    executeTestMethod(test, Object.class, stack, (Object) null);
    assertStack(new Object[]{2,null,null,null}, stack);
    executeTestMethod(test, Object.class, stack, new Object());
  ...
  public void testIFNONNULL() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new Branch(IFNONNULL.class, 4), new ICONST(1), new RETURN(), new ICONST(2), new RETURN());
    final Object [] stack = new Object[100];
    executeTestMethod(test, Object.class, stack, (Object) null);
    assertStack(new Object[]{1,null,null,null}, stack);
    executeTestMethod(test, Object.class, stack, new Object());
  ...
  public void testATHROW_null() throws Throwable {
    final JJJVMClass test = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new ATHROW());
  ...
  public void testMONITORENTER_MONITOREXIT_jjjvmobject() throws Throwable {
    ...
    final JJJVMClass test1 = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new MONITORENTER(), new ALOAD(1), new ARETURN());
    final JJJVMClass test2 = prepareTestClass(new DefaultProvider(), Type.OBJECT, new ALOAD(1), new MONITOREXIT(), new ALOAD(1), new ARETURN());
  ...
  public void testMONITORENTER_MONITOREXIT_notjjjvmobject() throws Throwable {
    ...
    final JJJVMProvider prov = new DefaultProvider(){
      @Override
